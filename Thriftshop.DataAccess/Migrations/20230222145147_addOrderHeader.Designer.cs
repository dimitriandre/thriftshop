...
namespace Thriftshop.DataAccess.Migrations
{
    ...
    [Migration("20230222145147_addOrderHeader")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thriftshop.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Thriftshop.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Thriftshop.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Thriftshop.Models.OrderDetail", b =>
                {
                    b.HasOne("Thriftshop.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Thriftshop.Models.OrderHeader", b =>
                {
                    b.HasOne("Thriftshop.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Thriftshop.Models.ApplicationUser", b =>
                {
                    b.HasOne("Thriftshop.Models.Company", "Company")
                        .WithMany()
